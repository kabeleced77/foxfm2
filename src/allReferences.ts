...
/// <reference path="Common/DataAccess/SettingsRepositoryInterface.ts" />
/// <reference path="Common/DataAccess/SettingsRepository.ts" />

/// <reference path="Common/BusinessLogic/SettingsManagerInterface.ts" />
/// <reference path="Common/BusinessLogic/SettingsManager.ts" />
/// <reference path="Common/BusinessLogic/StadiumManagerUi.ts" />
